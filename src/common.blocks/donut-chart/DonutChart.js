class DonutChart {
  ...
  _initDonutCircle() {
    this.$svg = DonutChart.createSVGElement('svg').attr({ class: 'donut-chart__chart-container' });
  ...
  static createSVGCircle(attributes) {
    ...
    return DonutChart.createSVGElement('circle').attr({ ...defaultAttributes, ...attributes });
  }
